...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMOPortal.Data.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MMOPortal.GameApi.Data.Character<MMOPortal.Data.ApplicationUser, System.Guid>", b =>
                {
            ...
            modelBuilder.Entity("MMOPortal.GameApi.Data.Character<MMOPortal.Data.ApplicationUser, System.Guid>", b =>
                {
                    b.HasOne("MMOPortal.Data.ApplicationUser", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("MMOPortal.Data.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("MMOPortal.Data.ApplicationUser", null)
                        .WithMany()
